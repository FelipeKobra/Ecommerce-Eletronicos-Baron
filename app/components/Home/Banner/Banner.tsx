...
export default function Banner() {
  return (
    <div className="grid grid-cols-7 mt-5 w-full h-[50svh] sm:h-[60svh] text-center shadow-md rounded-sm bg-gradient-to-r from-sky-400 to-sky-600 ">
      <div className="col-span-7 xl:col-span-4 flex flex-col justify-center items-center select-none">
        <h1 className="text-5xl sm:text-6xl md:text-7xl text-white font-bold">
          Liquidação De Verão
        </h1>
      ...
      <div className=" hidden xl:col-span-3 xl:flex  justify-center items-center ">
        <div className="relative w-full h-full xl:h-5/6">
          <Image
            priority={true}
